        ...
        <div class="col-lg-12">
            ...
            <div class="well">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="manufactureId">
                            ...
                            @foreach($manufacture as $manufactures)
                                <option value="{{$manufactures->id}}">{{$manufactures->manufactureName}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="number" class="form-control" name="productShortDescription" rows="6"></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="number" class="form-control" name="productLongDescription" rows="10"></textarea>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-success btn-block" name="btn">Save Product Info</button>
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
